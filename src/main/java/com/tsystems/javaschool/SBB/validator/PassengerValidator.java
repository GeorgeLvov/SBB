...
public class PassengerValidator implements Validator {
    ...
    TicketDTO rawTicketDTO;

    public void setTicketDTO(TicketDTO ticketDTO) {
        this.rawTicketDTO = ticketDTO;
    }
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (passengerService.isPassengerAlreadyCheckedIn(passengerDTO.getFirstName(), passengerDTO.getLastName(), passengerDTO.getBirthDate(), rawTicketDTO)) {
