...
public class TicketPDFExporter {
    ...
    public TicketPDFExporter(TicketDTO ticketDTO) {
        ...
        stationFrom = ticketDTO.getStationFromDTO().getTitle();
        stationTo = ticketDTO.getStationToDTO().getTitle();
        departureTime = sdf.format(ticketDTO.getDepartureTime());
        arrivalTime = sdf.format(ticketDTO.getArrivalTime());

        firstName = ticketDTO.getPassengerDTO().getFirstName();
        lastName = ticketDTO.getPassengerDTO().getLastName();
